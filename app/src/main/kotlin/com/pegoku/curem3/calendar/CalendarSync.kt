 ...
 */
package com.pegoku.curem3.calendar
...
object CalendarSync {
    private const val TAG_PREFIX = "cure-m3:"
    ...
    fun buildIcs(context: Context, data: CureData, reminders: ReminderSettings): String {
        ...
        sb.append("BEGIN:VCALENDAR\r\nVERSION:2.0\r\nPRODID:-//cure-m3//Afvalkalender//NL\r\nCALSCALE:GREGORIAN\r\n")
        ...
        data.pickups.forEach { day ->
            ...
            sb.append("UID:").append(day.type).append('-').append(day.date).append("@cure-m3\r\n")
