...
import com.pegoku.ophaaldag.ui.AddressResult
...
fun AddressScreen(vm: AppViewModel, onBack: (() -> Unit)?, onDone: () -> Unit) {
    ...
    val postcodeValid = POSTCODE.matches(normalised) || normalised == "DEMOCURE"

    LaunchedEffect(normalised) {
        if (postcodeValid && normalised != "DEMOCURE") {
    ...
    Scaffold(
        ...
        Column(
            ...
            if (onBack == null) {
                ...
                TextButton(
                    onClick = { postcode = "DEMOCURE"; house = "0"; suffix = "0"; street = "" },
